            ...
            <div class="content-wrapper" style="background-color: white;">
                <table class="table table-bordered table-striped border-0 m0">
                    ...
                    <tr>
                        ...
                        <td>{{ $item['rate_status'] ?? "Chưa xếp loại"}}</td>
                        <td>{{ $item['rate_date'] ?? "Chưa đánh giá" }}</td>
                        <td class="text-center">
                            <button @if(!$item['topic'] || $item['rate_status']) disabled @endif class="btn btn-info border-0 btn-topic-custom" data-toggle="tooltip" data-placement="top" title="Đánh giá"><i class="fas fa-award"></i></button>
