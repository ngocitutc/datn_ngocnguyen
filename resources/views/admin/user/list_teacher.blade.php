                        ...
                        <div class="row">
                            <div class="m10r">
                                <select class="form-control" name="subject" id="select-role">
                                    ...
                                    <option value="1" @if(request()->subject == "1") selected @endif>{{ SUBJECTS[1] }}</option>
                                    <option value="2" @if(request()->subject == "2") selected @endif>{{ SUBJECTS[2] }}</option>
                                    <option value="3" @if(request()->subject == "3") selected @endif>{{ SUBJECTS[3] }}</option>
                                </select>
                            </div>
                            <div>
